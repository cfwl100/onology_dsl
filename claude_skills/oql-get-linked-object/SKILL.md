---
name: oql_get_linked_object
description: "Generate strict OQL DSL JSON for operation GET_LINKED_OBJECT. Use when user intent maps to GET_LINKED_OBJECT and needs machine-consumable ontology object operation payload with minimal ambiguity."
---

# OQL GET_LINKED_OBJECT Skill
...
3. `version` 固定为 `"1.8.0"`。
4. `operation` 固定为 `"GET_LINKED_OBJECT"`。
...
```json
{
  ...
  "linkQuery": {"relationship": "placedBy", "targetObjectType": "Customer"},
