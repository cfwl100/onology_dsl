...
- 操作边界：`LINK_QUERY`（单跳关联读取）。
- 关键边界：`objects` 必须恰好 2 个且必须提供 `linkQuery`；禁止 `relationships/mutation`。

## 6. 最小合法样例（S-OQL 形态）

```json
{"version":"1.0","schemaRef":"demo","strict":true,"operation":"LINK_QUERY","objects":[{"objectType":"User","alias":"u"},{"objectType":"Order","alias":"o"}],"conditions":["u.id","EQ","U001"],"linkQuery":{"mode":"LIST","relationshipType":"USER_ORDER","sourceRef":"u","targetRef":"o","direction":"OUT"},"returns":[["FIELDS","o",["id","orderNo"]]]}
```
