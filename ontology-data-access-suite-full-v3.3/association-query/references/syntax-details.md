...
- 操作边界：`ASSOCIATION_QUERY`（多跳关联读取）。
- 关键边界：必须包含 `relationships` 且按路径顺序；禁止 `linkQuery/mutation`。

## 6. 最小合法样例（S-OQL 形态）

```json
{"version":"1.0","schemaRef":"demo","strict":true,"operation":"ASSOCIATION_QUERY","objects":[{"objectType":"User","alias":"u"},{"objectType":"Order","alias":"o"}],"relationships":[{"relationshipType":"USER_ORDER","alias":"r1","from":"u","to":"o"}],"conditions":["u.id","EQ","U001"],"returns":[["FIELDS","o",["id","orderNo"]]]}
```
