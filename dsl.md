...
> **SUBGRAPH 操作详情**：请参阅《本体对象操作语言(OQL)-子图DSL规范v1.0.md》，包含 objects、links、deletes 的批量操作设计。
...
> **SUBGRAPH API**：请参阅《本体对象操作语言(OQL)-子图DSL规范v1.0.md》了解详情。
